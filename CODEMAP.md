...
| `lib/shef/` | `shef`: ishlab chiqarish buyurtmasi yaratish, bosqichlarni qabul/rad, полуфабрикат limiti va qoldig'i | `ShefHomeUi`, `ShefCreateOrderUi`, `ShefOrderDetailUi`, `PfStockPage` (пф qoldig'i: Bor/Band/Mumkin). Provider: `ShefProvider` |
