...
| `lib/core/` | umumiy yadro: DI, tarmoq, lokal saqlash, endpointlar, birlik konverti, media | `di.dart`, `urls.dart` (`AppUrls`), `dio_settings.dart`, `order_socket.dart`, `qty_units.dart`, `piece_weight.dart` (nomdan «1шт=Xгр»), `context_extension.dart`, `media/*` (kamera/video), `data/local/products_cache.dart` (mahsulotlar ro'yxatining lokal keshi + fon isolate'da parse) |
