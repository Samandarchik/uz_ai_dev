...
| ui | `lib/admin/ui/tech_card_editor_page.dart` | `TechCardEditorPage` — Excel «тех карта» varag'iga o'xshash muharrir. `canEditPrices: false` (shef rejimi) — narx/«Сумма»/tannarx kataklari ko'rinadi, «Цена продажи»/«Прибыль»/«Доп. расходы» faqat o'qiladi, «Цена» katagi xarid tarixini qo'lda narx blokisiz ochadi |
