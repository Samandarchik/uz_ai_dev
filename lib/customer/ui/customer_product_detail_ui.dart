...
class CustomerProductDetailUi extends StatelessWidget {
  final int productId;

  const CustomerProductDetailUi({super.key, required this.productId});
  ...
  CustomerProductModel? _findProduct(CustomerProvider provider) {
