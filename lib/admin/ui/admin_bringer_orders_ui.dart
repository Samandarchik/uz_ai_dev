...
class AdminBringerOrdersUi extends StatefulWidget {
  const AdminBringerOrdersUi({super.key});

  @override
  State<AdminBringerOrdersUi> createState() => _AdminBringerOrdersUiState();
}

class _AdminBringerOrdersUiState extends State<AdminBringerOrdersUi> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Bringer xaridlari')),
                            ...
                            onPressed: () async {
                              final confirm = await showDialog<bool>(
                                ...
                                builder: (_) => AlertDialog(
                                  ...
                                  content:
                                      const Text('Bu orderni tasdiqlaysizmi?'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                              ...
                              if (confirm == true) {
                                await provider.deliverOrder(order.id);
                              }
                            },
                          )
                        : null,
