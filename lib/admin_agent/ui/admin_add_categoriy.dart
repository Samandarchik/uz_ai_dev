...
import 'package:uz_ai_dev/admin_agent/ui/dealog.dart';
...
class _CategoryManagementScreenState extends State<CategoryManagementScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<CategoryProviderAdminAgentUpload>().getCategories();
    });
  }

  void _showCreateDialog() {
    showDialog(context: context, builder: (context) => const CategoryDialog());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [
          IconButton(icon: Icon(Icons.add), onPressed: _showCreateDialog),
        ],
      ),
      body: Consumer<CategoryProviderAdminAgentUpload>(
